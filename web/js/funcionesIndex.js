//let enlaceLogin = document.getElementById("enlaceLogin");
//let enlaceCargaUsuario = document.getElementById("enlaceCargaUsuario");
//
//enlaceCargaUsuario.addEventListener("click", cargarAltaUsuario());
//enlaceLogin.addEventListener("click", cargarLogin());
